...
import com.example.notificationservice.listener.OrderEventStreamListener;
import com.example.notificationservice.listener.PaymentEventStreamListener;
...
public class RedisStreamConfig {
    ...
    @Bean
    public Subscription orderSubscription(RedisConnectionFactory connectionFactory) {
    ...
    @Bean
    public Subscription paymentSubscription(RedisConnectionFactory connectionFactory) {
        var options = StreamMessageListenerContainer.StreamMessageListenerContainerOptions
                .builder()
                .pollTimeout(Duration.ofSeconds(1))
                .build();
